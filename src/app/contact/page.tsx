...
import { fadeInUp, defaultViewport } from '@/components/animations';
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-gabarito font-bold text-[#0D0B05] mb-4">
            Contact Us
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className=" text-black mt-1 px-3 block w-full h-9 rounded-xl border-gray-700 shadow-sm focus:border-[#071D54] focus:ring-[#071D54] font-open-sans"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="text-black mt-1 block px-3 h-9 w-full rounded-xl border-gray-300 shadow-sm focus:border-[#071D54] focus:ring-[#071D54] font-open-sans"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="text-black mt-1 block px-3 w-full h-9 rounded-xl border-gray-300 shadow-sm focus:border-[#071D54] focus:ring-[#071D54] font-open-sans"
              />
            </div>
